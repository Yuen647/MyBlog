<template>
    ...
    <!-- 文章标题、标签、Meta 信息 -->
    <div class="sticky top-0 z-10 backdrop-blur-md bg-white/70 dark:bg-gray-900/70 shadow-sm">
        <div class="max-w-screen-xl flex flex-col flex-wrap mx-auto px-4 md:px-6 pb-8 pt-6">
            <!-- 标签集合 -->
            <div v-if="article.tags && article.tags.length > 0" class="mb-4">
                <span @click="goTagArticleListPage(tag.id, tag.name)" v-for="(tag, index) in article.tags" :key="index"
                    class="inline-block mb-1 cursor-pointer bg-green-100/80 text-green-800 text-sm font-medium me-2 
                    px-3 py-1 rounded-full hover:bg-green-200/80 hover:text-green-900 transition-colors duration-200
                    dark:bg-green-900/80 dark:hover:bg-green-950/80 dark:text-green-300">
                    # {{ tag.name }}
                </span>
            </div>
            
            <!-- 文章标题 -->
            <h1 class="font-bold text-4xl md:text-5xl mb-6 dark:text-white/90 tracking-tight">{{ article.title }}</h1>

            <!-- Meta 信息 -->
            <div class="flex flex-wrap items-center gap-3 md:gap-5 text-gray-500 dark:text-gray-400 text-sm">
                <!-- 字数 -->
                <div class="inline-flex items-center px-2.5 py-1.5 rounded-md bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200" 
                    data-tooltip-target="word-tooltip-bottom" data-tooltip-placement="bottom">
                    <svg t="1701512226243" class="w-4 h-4 mr-1.5 icon" viewBox="0 0 1024 1024" version="1.1"
                        ...
                        <path
                            ...
                            p-id="28618" fill="currentColor"></path>
                    </svg>
                ...
                <!-- 阅读时长 -->
                <div class="inline-flex items-center px-2.5 py-1.5 rounded-md bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200" 
                    data-tooltip-target="read-time-tooltip-bottom" data-tooltip-placement="bottom">
                    <svg t="1701512553358" class="w-4 h-4 mr-1.5 icon" viewBox="0 0 1024 1024" version="1.1"
                        ...
                        <path
                            ...
                            fill="currentColor" p-id="37813"></path>
                    </svg>
                    {{ article.readTime }}
                </div>
                ...
                <!-- 发布时间 -->
                <div class="inline-flex items-center px-2.5 py-1.5 rounded-md bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200" 
                    data-tooltip-target="publish-time-tooltip-bottom" data-tooltip-placement="bottom">
                    <svg t="1701513012543" class="w-4 h-4 mr-1.5 icon" viewBox="0 0 1024 1024" version="1.1"
                        ...
                        <path
                            ...
                            fill="currentColor" p-id="41601"></path>
                    </svg>
                    {{ article.createTime }}
                </div>
                ...
                <!-- 分类 -->
                <div class="inline-flex items-center px-2.5 py-1.5 rounded-md bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200" 
                    data-tooltip-target="category-tooltip-bottom" data-tooltip-placement="bottom">
                    <svg t="1701513357854" class="w-4 h-4 mr-1.5 icon" viewBox="0 0 1024 1024" version="1.1"
                        ...
                        <path
                            ...
                            fill="currentColor" p-id="50561"></path>
                        <path
                            ...
                            fill="currentColor" p-id="50562"></path>
                    </svg>
                    <a @click="goCategoryArticleListPage(article.categoryId, article.categoryName)"
                        class="cursor-pointer hover:underline">{{ article.categoryName }}</a>
                </div>

                <!-- 阅读量 -->
                <div class="inline-flex items-center px-2.5 py-1.5 rounded-md bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200" 
                    data-tooltip-target="read-num-tooltip-bottom" data-tooltip-placement="bottom">
                    <svg t="1701513523793" class="w-4 h-4 mr-1.5 icon" viewBox="0 0 1024 1024" version="1.1"
                        ...
                        <path
                            ...
                            fill="currentColor" p-id="56113"></path>
                    </svg>
                    {{ article.readNum }} 次
                </div>
            </div>
    ...
    <div id="word-tooltip-bottom" role="tooltip"
        class="absolute z-10 invisible inline-block px-3 py-2 text-xs font-medium text-white bg-gray-900/90 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
        总字数
...
::v-deep(.copy-icon) {
    --copy-icon: url("data:image/svg+xml;utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' height='20' width='20' stroke='rgba(128,128,128,1)' stroke-width='2'%3E%3Cpath stroke-linecap='round' stroke-linejoin='round' d='M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4'/%3E%3C/svg%3E");
